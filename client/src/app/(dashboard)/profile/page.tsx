        ...
        <div style={{ maxWidth: 680 }}>
          ...
          <div className="card" style={{ marginBottom: 20 }}>
            ...
            {[
              ...
              { label: 'Reply to chat', detail: 'Enables Profile-based AI reply routing. WhatsApp Automation from the sidebar remains independent.', value: aiReplyEnabled, set: setAiReplyEnabled, icon: Bot },
              { label: 'Reply from AI only', detail: 'Uses OpenAI/Gemini when WhatsApp Automation is Off. An active sidebar chatbot flow takes priority.', value: aiOnlyReplyEnabled, set: setAiOnlyReplyEnabled, icon: Sparkles },
